...
-- 4 random projects
insert into app_project (id, description, open_date, close_date, enabled, vehicle_id, department_id) values (0, 'Undefined', '2023-01-01', '2023-12-31', 0, 1, 1);
insert into app_project (description, open_date, close_date, enabled, vehicle_id, department_id) values ('Proyecto 1', '2023-01-01', '2023-12-31', 1, 1, 1);
insert into app_project (description, open_date, close_date, enabled, vehicle_id, department_id) values ('Proyecto 2', '2023-01-02', '2023-12-31', 1, 2, 2);
insert into app_project (description, open_date, close_date, enabled, vehicle_id, department_id) values ('Proyecto 3', '2023-01-03', '2023-12-31', 0, 3, 3);
insert into app_project (description, open_date, close_date, enabled, vehicle_id, department_id) values ('Proyecto 4', '2023-01-04', '2023-12-31', 0, 4, 4);
